...
// Todoリストの機能を入力された文字によって使い分けるための文字列を配列で所持する
//   - 変数名は「commands」とする
...
// promptで入力したものを保持しておくための変数「input」を用意する
let input;

// 「終了」と入力されたらループを終了するwhileループを作成する
...
// Whileループを抜けた後もタスク一覧を表示する(最終的なタスク一覧を確認するため)
showTodos();
